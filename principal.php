  ...
  <div class="row">    
    ...
    <div class="large-3 pull-9 columns">
      ...
      <ul class="side-nav">
        ...
        ?>
        <li><h5><a href="pqr.php">PQR</a></h5></li>
        <li><h5><a href="#">Forma de pagos</a></h5></li>
        <li><h5><a href="#">Ayuda</a></h5></li>
        <li><h5><a href="#">Chat</a></h5></li>
        <li><h5><a href="#">Cliente</a></h5></li>
        <li><h5><a href="#">Tutor</a></h5></li>
         <?php
          }
         ?> 
